...
public class LoginActivity extends AppCompatActivity implements LoginFragment.LoginFragmentInterface,
    ...
    private void loadDBWithTestRestaurants(){
        ...
        Restaurant logjam = new Restaurant("Log Jam", "address", "ChIJZ8EG-aF7-IcRk6UJVSnQMOY", 1, "pictureID", "website");
        ...
        Restaurant jeffs = new Restaurant("Jeff's Pizza", "address", "ChIJEerOHaJ7-IcRhvqsXhVLrrM", 1, "pictureID", "website");
        ...
        Restaurant rawdeal = new Restaurant("Raw Deal", "address", "ChIJpzKPC6J7-IcRjaZaIa1HGGE", 1, "pictureID", "website");
        ...
        Restaurant g1 = new Restaurant("g1", "address", "g1", 1, "pictureID", "website");
        ...
        Restaurant g2 = new Restaurant("g2", "address", "g2", 1, "pictureID", "website");
        ...
        Restaurant g3 = new Restaurant("Log Jam", "address", "g3", 1, "pictureID", "website");
        ...
        Restaurant g4 = new Restaurant("Log Jam", "address", "g4", 1, "pictureID", "website");
    ...
    private void loadDBWithTestRestaurants2(){
        ...
        Restaurant teds = new Restaurant("Ted's Pizza", "address", "ChIJB83FKpl7-IcR2-rdR8sXpoA", 1, "pictureID", "website");
        ...
        Restaurant culvers = new Restaurant("Culver's", "address", "ChIJuXfu9IZ7-IcRCwPsEykvwh0", 1, "pictureID", "website");
        ...
        Restaurant cancun = new Restaurant("Cancun", "address", "ChIJR_CLM3h8-IcR1_9XD8oA2ac", 1, "pictureID", "website");
